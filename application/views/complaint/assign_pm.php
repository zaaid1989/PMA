...
<?php
	...
	$zquery="select * from tbl_instruments where pk_instrument_id='" .$equipment_id."'";
	...
	if(substr($client_id,0,1)=='o')
		...
		{
			$tyz	=	$this->db->query("select * from tbl_clients where pk_client_id='".$client_id."'");
			...
			$client_city	= 	$rt4[0]['city_name'];
			$client_area	=	$rt5[0]['area'];
		}
