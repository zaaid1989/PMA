                          ...
                          <form  action="<?php echo base_url(); ?>complaint/complete_complaint_resgistration"  enctype="multipart/form-data" class="form-horizontal" method="post">
                            ...
                            <div class="form-body">
                              <div class="form-group">
                                ...
                                <div class="col-md-4">
                                  <?php
									  $data_query = $this->db->query("SELECT * FROM tbl_complaints where pk_complaint_id='".$this->uri->segment(3)."'");
                              ...
                              <div id="instrument" <?php if($data_result[0]['problem_type']!='equipment'){ echo 'style="display:none"';}?>>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-4 instrument_name">
                                      <select name="instrument_name" class="form-control" onchange="add_serial_no(this.value)">
										  ...
										  ?>
                                          <option value="<?php echo $data_result[0]['fk_instrument_id']?>" selected="selected"><?php echo $new_product[0]['product_name']?></option>
                                          <?php }?>
                                      </select>
                                    </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                      ...
                                      value="<?php if ($quer->num_rows()>0){echo $resul[0]['office_name'];}?>"/>
                                      <input type="hidden" name="office_hidden_id" class="office_hidden_id"  
                                      value="<?php  if ($quer->num_rows()>0){ echo $data_result[0]['fk_office_id'];}?>"/>
                                    </div>
                                  </div>
