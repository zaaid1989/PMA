                            ...
                            if (sizeof($rt22) == "0") {
                                ...
                                foreach ($rt22 as $get_users_list) {
                                    ...
                                    <tr class="odd gradeX">
										...
										<td>
                                            <?php 
                                            $ty44=$this->db->query("select office_name from tbl_offices 
											LEFT JOIN user ON user.fk_office_id = tbl_offices.pk_office_id
											LEFT JOIN tbl_fine ON tbl_fine.fk_employee_id = user.id
