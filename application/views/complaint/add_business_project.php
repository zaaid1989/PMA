                            ...
                            <div class="col-md-8 territory_td">
                                    ...
                                    <select class="form-control  " name="Territory" id="Territory" required>
                                      <?php 
										if($this->uri->segment(3)!='')
										{
											echo '<option value="'.$rtw4[0]['pk_office_id'].'">'.$rtw4[0]['office_name'].'</option>';
										}
										else
										{
											echo '<option value="">--Choose--</option>';
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 city_td">
                                    ...
                                    <select class="form-control  " name="City" id="City" required>
										...
										if($this->uri->segment(3)!='')
										{
											echo '<option value="'.$rtw2[0]['pk_city_id'].'">'.$rtw2[0]['city_name'].'</option>';
										}
										else
										{
											echo '<option value="">--Choose--</option>';
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 area_td">
                                    <select class="form-control  " name="Area" id="Area" required>
										...
										if($this->uri->segment(3)!='')
										{
											echo '<option value="'.$rtw3[0]['pk_area_id'].'">'.$rtw3[0]['area'].'</option>';
										}
										else
										{
											echo '<option value="">--Choose--</option>';
